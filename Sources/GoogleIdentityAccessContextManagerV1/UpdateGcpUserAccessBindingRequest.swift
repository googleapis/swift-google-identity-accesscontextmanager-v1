  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = UpdateGcpUserAccessBindingRequest().with { $0.gcpUserAccessBinding = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let gcpUserAccessBinding = CodingKeys(stringValue: "gcpUserAccessBinding")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.gcpUserAccessBinding, forKey: .gcpUserAccessBinding)
