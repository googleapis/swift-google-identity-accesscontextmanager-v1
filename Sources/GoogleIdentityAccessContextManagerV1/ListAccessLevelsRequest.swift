...
public struct ListAccessLevelsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let accessLevelFormat = CodingKeys(stringValue: "accessLevelFormat")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(LevelFormat.self, forKey: .accessLevelFormat) {
      self.accessLevelFormat = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.accessLevelFormat, forKey: .accessLevelFormat)
