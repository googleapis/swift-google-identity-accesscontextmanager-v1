...
public struct GcpUserAccessBinding: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let groupKey = CodingKeys(stringValue: "groupKey")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .groupKey) {
      self.groupKey = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.groupKey, forKey: .groupKey)
