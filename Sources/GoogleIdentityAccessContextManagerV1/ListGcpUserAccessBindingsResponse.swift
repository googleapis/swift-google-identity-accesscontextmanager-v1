  ...
  Sendable
{
  ...
  public var gcpUserAccessBindings: [GcpUserAccessBinding] = []
  ...
  /// Initialize a new instance of `ListGcpUserAccessBindingsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGcpUserAccessBindingsResponse().with { $0.gcpUserAccessBindings = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let gcpUserAccessBindings = CodingKeys(stringValue: "gcpUserAccessBindings")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [GcpUserAccessBinding].self, forKey: .gcpUserAccessBindings)
    {
      self.gcpUserAccessBindings = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.gcpUserAccessBindings, forKey: .gcpUserAccessBindings)
